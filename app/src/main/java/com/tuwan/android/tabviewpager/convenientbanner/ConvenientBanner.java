...
import com.tuwan.android.tabviewpager.convenientbanner.adapter.CBPageAdapter;
import com.tuwan.android.tabviewpager.convenientbanner.holder.CBViewHolderCreator;
import com.tuwan.android.tabviewpager.convenientbanner.listener.CBPageChangeListener;
import com.tuwan.android.tabviewpager.convenientbanner.listener.OnItemClickListener;
import com.tuwan.android.tabviewpager.convenientbanner.view.CBLoopViewPager;
...
public class ConvenientBanner<T> extends LinearLayout {
    ...
    private void init(Context context) {
        View hView = LayoutInflater.from(context).inflate(R.layout._include_viewpager, this, true);
     ...
     * 指示器的margin
     */
    public ConvenientBanner setPageIndicatorMargin(int marginLeft, int marginTop, int marginRight, int marginBtm) {
        RelativeLayout.LayoutParams layoutParams = (RelativeLayout.LayoutParams) loPageTurningPoint.getLayoutParams();
        layoutParams.setMargins(marginLeft, marginTop, marginRight, marginBtm);
        return this;
    }
